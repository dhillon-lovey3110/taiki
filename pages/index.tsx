...
const HomePage:NextPage = () => {
      ...
      return <>
        <div className='mx-auto max-w-7xl relative px-4'>
          ...
          <div className='hidden md:block absolute bottom-0 right-0 z-10' onClick={handleLamp}>
            <img src="/assets/images/smoke.gif" alt="smoke" className='absolute w-14 bottom-[75px] right-[145px]' />
          ...
          <div className='hidden md:block absolute bottom-0 left-0 z-10'>
              ...
              <img src="/assets/images/music-playing.gif" alt="music symbols" className={playerActive?"w-[150px] absolute left-[70px] bottom-[200px]":"hidden"} />
              <img src="/assets/images/music-player.svg" alt="books and light" className='w-full' />
          </div>
        </div>
        <NFTS />
      </>;
  ...
  const funCollection = () => {
    return <>
      <div className='mx-auto max-w-5xl relative px-4' ref={whatIsTaikiFriendsRef}>
          <div className='flex flex-col items-center py-16 md:space-x-[32px] md:flex-row md:justify-center'>
            <div className='flex-1 max-w-[30rem] content-center font-ppagradirBold text-[38px]'>
              A fun collection for dog and music lovers.
            </div>
            <div className='flex-1 max-w-[30rem] flex items-center'>
        ...
        <div className='mx-auto max-w-5xl relative mb-12 px-4'>
          <div className='flex flex-col items-center md:space-x-[32px] md:flex-row md:justify-center'>
            ...
            <div className='flex-grow-1 max-w-[30rem] content-center bg-[#191B13] rounded-2xl'>
              ...
              <img src='/assets/images/holder-perks.svg' alt='' />
            </div>
          </div>
        </div>
    </>;
  ...
  const taikiMap = () => {
    return <>
        <div className='mx-auto max-w-7xl mt-36 relative px-4' ref={taikiMapRef}>
          <div className='max-w-3xl mx-auto mb-7'>
          ...
          <div className='flex flex-col items-center md:justify-center md:space-x-[32px] md:flex-row mb-10'>
            <div className='flex-grow-1 max-w-[32rem] content-center mb-[32px] md:mb-[0] bg-darkBlue rounded-[32px] relative overflow-hidden'>
              <div className='bg-[#334C85] p-5 m-8 rounded-[32px] flex gap-7 align-middle'>
            ...
            <div className='flex-grow-1 max-w-[32rem] content-center bg-darkGreen rounded-[32px] relative overflow-hidden'>
              <div className='bg-[#397E40] p-5 m-8 rounded-[32px] flex gap-7 align-middle'>
        ...
        <div className='flex flex-col items-center md:justify-center md:space-x-[32px] md:flex-row'>
            <div className='flex-grow-1 max-w-[32rem] content-center mb-[32px] md:mb-[0] bg-darkRed rounded-[32px] relative overflow-hidden'>
              <div className='bg-[#AA4537] p-5 m-8 rounded-[32px] flex gap-7 align-middle'>
            ...
            <div className='flex-grow-1 max-w-[32rem] content-center bg-darkYellow rounded-[32px] relative overflow-hidden'>
              <div className='bg-[#B39337] p-5 px-3 m-8 rounded-[32px] flex gap-7 align-middle'>
        ...
        <div className='mx-auto max-w-md font-ppagradir !text-[21px] text-dark leading-10 relative mt-12 mb-12 text-center'>We’re constantly working to refine and improve our roadmap. Keep up with the progress here.</div>
    </>;
  }

  const faq = () => {
    return <>
      <div className='mx-auto max-w-7xl mt-36 relative px-5' ref={FaqRef}>
  ...
  const teamTaiki = () => {
    return <>
      <div className='mx-auto max-w-7xl mt-36 relative px-4' ref={taikiTeamRef}>
  ...
  const hangWithUs = () => {
    return <>
      <div className='mx-auto max-w-7xl mt-36 relative px-4'>
          ...
          <p className='text-center mb-48'><a className="bg-white inline-flex text-black px-5 py-3 rounded-full font-ppagradir cursor-pointer leading-8 transition-all duration-500 hover:bg-buttonHover hover:scale-110"><img src="/assets/images/discord-black.svg" alt="" className="mr-3" />Join the Discord</a></p>
        </div>
    </>;
  }
